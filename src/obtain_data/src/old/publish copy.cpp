...
public:
        ...
        : Node("joint_state_publisher")
    {
        ...
        timer1_ = this->create_wall_timer(
            1s, std::bind(&DynamixelStatePublisher::timer1_callback, this));
        timer2_ = this->create_wall_timer(
            2s, std::bind(&DynamixelStatePublisher::timer2_callback, this));
    }
...
private:
    ...
    void timer1_callback()
    {
        ...
        RCLCPP_INFO(get_logger(), "Timer 1 callback");
    }
